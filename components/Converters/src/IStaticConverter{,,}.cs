...
/// <typeparam name="TParam">The type of the conversion parameter.</typeparam>
/// <typeparam name="TTo">The type of value to convert to.</typeparam>
public interface IStaticConverter<TFrom, TParam, TTo>
{
    /// <summary>
    /// Apply the convert operation.
    /// </summary>
    /// <param name="value">The value to convert from.</param>
    /// <param name="param">The conversion parameter.</param>
    /// <returns>The converted value.</returns>
    static abstract TTo Convert(TFrom value, TParam param);
}
